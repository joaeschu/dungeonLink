hechizos ={
    "Bardo_0" :["Burla cruel", "Cuchichear mensaje", "Ilusión menor", "Impacto verdadero", "Luces danzantes", "Luz", "Mano del mago",
                     "Prestidigitación"],
    "Bardo_1":["Encantar Animal", "Caer como una pluma", "Comprensión idiomática", "Curar heridas", "Detectar magia",
